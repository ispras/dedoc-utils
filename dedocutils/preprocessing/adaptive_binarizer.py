...
class AdaptiveBinarizer(AbstractPreprocessor):
    """
    This class is used for image binarization.
    It uses adaptive threshold to make coloured document image into black-and-white.
    The implementation of the method is described at https://stackoverflow.com/questions/56905592/
    """
    def __init__(self, block_size: int = 40, delta: int = 40) -> None:
        """
        :param block_size: size of the block where independent adaptive analysis is executed
        :param delta: binarization threshold
        """
