...
from dedocutils.text_detection.doctr_text_detector.doctr.transforms import Resize
...
class PreProcessor(nn.Module):
    ...
    def __call__(
        ...
        if isinstance(x, (np.ndarray, torch.Tensor)):
            ...
            samples = [self.sample_transforms(xi) for xi in x]
            # Batching
        ...
        batches = [self.normalize(batches_i) for batches_i in batches]
